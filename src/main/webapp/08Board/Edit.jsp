...
<!DOCTYPE html><html><head><meta charset="UTF-8"><title>Edit.jsp : 이미 View.jsp에 있는 객체를 가져와 수정하는 폼 </title>
...
<h2>회원제 게시판 - 글 수정하기(Edit)</h2>
<form name="EditFrm" method="post" action="EditProcess.jsp"
      onsubmit="return validateForm(this);">
      
    <input type="hidden" name="num" value="<%= boardDTO.getNum() %>" /> <!-- 요청 값 -->
    ...
    <table border="1" width="90%">
        ...
        <tr>
            <td>내용</td>
            <td>
                <textarea name="content" style="width: 90%; height: 100px;"><%=boardDTO.getContent() %></textarea> <!-- 100px 과 boardDTO 사이에 여백이 있으면 인식이 되기 때문에 웹페이지에서 가운데로 표시 되므로 여백을 제거해야 작성된 내용이 왼쪽으로 나타난다. -->
            </td>
        </tr>
        <tr>
