...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%
    	...
    	String loginID = CookieManager.readCookie(request, "loginID"); // 내가 만든 쿠키 관리자 클래스 활용.
    ...
    %>
<!DOCTYPE html><html><head><meta charset="UTF-8"><title>IdSaveMain.jsp : 쿠키를 이용한 id 저장 및 경고창 테스트 </title>
</head>
<body>
