<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<!DOCTYPE html><html><head><meta charset="UTF-8"><title>RequestMain.jsp : 요청에 대한 처리를 담당.</title>
</head>
<body>

	<!-- request는 클라이언트(고객)가 값을 요청할 때 처리 되는 내장된 메모리 영역 -->
	<!--  메서드는 2개가 있는데 GET 방식과 POST 방식이 있다. -->
	<!-- GET 방식 : URL 통해서 요청하는 방법이며 가볍지만 보안상 좋지 않다.  -->
	<!-- POST 방식 : BODY 통해서 요청하는 방법이며 보안상 좋으며 대용량 처리가 가능하고 무겁다.  -->

	<h1> 1. 클라이언트 와 서버의 환경정보 읽기 </h1>
	...
	아이디 : <input type="test" name="id" value= ""/><br>
	
	성별 : <!-- radio : 단일 선택용 -->
		<input type="radio" name="sex" value="man"/>남자
		<input type="radio" name="sex" value="woman"/>여자 <br>
		
	관심사항 : <!-- checkbox : 복수 선택용  -->
	...
	<a href= "RequestHeader.jsp"> 환영합니다. 
	</a>
