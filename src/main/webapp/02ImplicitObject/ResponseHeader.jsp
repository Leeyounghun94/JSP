...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    response.addHeader("resp_str", request.getParameter("add_str"));// add =추가
    response.setHeader("resp_str", "김기원"); // set = 수정
    
    
    %>
<!DOCTYPE html><html><head><meta charset="UTF-8"><title>ResponseHeader.jsp : get으로 받은 날짜, 숫자, 문자 처리</title>
</head>
<body>
	...
	for(String hName : headerNames) {// 헤더의 컬렉션에 있는 이름들을 한 개씩 반복
		String hValue = response.getHeader(hName);// 이름과 같은 값을 변수에 넣는다.
